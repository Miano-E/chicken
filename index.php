...
<body>
	<div class="overlay"></div>
	 <div class="container">
		...
		<main> 
            <div class="left-col">
				<h1>Your Path to Chicken Prosperity Begins Here</h1>
				<p class = "subhead">
					Explore the best in chicken farming education, 
					premium products, and dedicated services.
					Start your journey towards thriving chicken farming today.
				</p>
		...
		<section class="more-info">
			...
			<div class="feature left">
				<div class="content">
					<h2>Premium Chicken Farming Solutions</h2>
					<p class="description">
						Discover our high-quality products designed to enhance poultry health, 
						productivity, and overall farm performance. Elevate your chicken 
						farming with our range of products.
					</p>
				</div>
				<img src="images/hen_chicks.jpg" alt="Hen" class = "chicken">
				</div>

				
			<div class="feature lefty">
				<div class="content">
					<h2>Comprehensive Support for Chicken Farmers</h2>
					<p class="description">
						We're committed to elevating your chicken farming venture through 
						services like farm consulting, training, and health support. 
						Let's build your poultry success together.
					</p>
				</div>
				<img src="images/rooster_hen.jpg" alt="Chicken" class = "Chicken">
			</div>

			<div class="feature flip">
				<div class="content">
					<h2>Your Gateway to Poultry Farming Solutions</h2>
					<p class="description">
